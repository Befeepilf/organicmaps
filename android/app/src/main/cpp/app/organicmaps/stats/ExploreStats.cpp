...
void EnsureIds(JNIEnv * env)
{
  if (g_PayloadClazz)
    return;
  g_PayloadClazz = jni::GetGlobalClassRef(env, "app/organicmaps/stats/ExploreStats$Payload");
  g_PayloadCtor = jni::GetConstructorID(
    env, g_PayloadClazz,
    "([Lapp/organicmaps/stats/ExploreStats$StatWeek;[Lapp/organicmaps/stats/ExploreStats$Region;)V");
  g_StatWeekClazz = jni::GetGlobalClassRef(env, "app/organicmaps/stats/ExploreStats$StatWeek");
  g_StatWeekCtor = jni::GetConstructorID(env, g_StatWeekClazz, "(JJ)V");
  g_RegionClazz = jni::GetGlobalClassRef(env, "app/organicmaps/stats/ExploreStats$Region");
...
extern "C"
{
JNIEXPORT jobject JNICALL Java_app_organicmaps_stats_ExploreStats_nativeGetAll(JNIEnv * env, jclass)
{
...
JNIEXPORT jobject JNICALL Java_app_organicmaps_stats_ExploreStats_nativeGetForRegion(JNIEnv * env, jclass,
                                                                                     jstring regionId)
{
  std::string id;
  if (regionId)
