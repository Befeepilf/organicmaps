...
extern "C"
{
JNIEXPORT jobject JNICALL Java_app_organicmaps_friends_Friends_nativeGetLists(JNIEnv * env, jclass)
{
...
JNIEXPORT void JNICALL Java_app_organicmaps_friends_Friends_nativeRefresh(JNIEnv *, jclass) { g_friends.Refresh(); }

JNIEXPORT jobjectArray JNICALL Java_app_organicmaps_friends_Friends_nativeSearchByUsername(JNIEnv * env, jclass,
                                                                                           jstring query)
{
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_friends_Friends_nativeSendRequest(JNIEnv * env, jclass, jstring userId)
{
  auto const id = jni::ToNativeString(env, userId);
  return static_cast<jboolean>(g_friends.SendRequest(id));
}

JNIEXPORT jboolean JNICALL Java_app_organicmaps_friends_Friends_nativeAcceptRequest(JNIEnv * env, jclass,
                                                                                    jstring userId)
{
  auto const id = jni::ToNativeString(env, userId);
...
JNIEXPORT jboolean JNICALL Java_app_organicmaps_friends_Friends_nativeCancelRequest(JNIEnv * env, jclass,
                                                                                    jstring userId)
{
  auto const id = jni::ToNativeString(env, userId);
